...
%   - COMSOL Multiphysics (6.2, 6.3 and 6.4)
...
ModelName = 'Model_Mircowire'; % -> CHANGE NAME TO MODEL REQUIRED
...
% Remove excess electrode
model.component('comp1').geom('geom1').create('int1', 'Intersection');
model.component('comp1').geom('geom1').feature('int1').selection('input').set({'ElectrodeInsulated' 'Tissue'});
